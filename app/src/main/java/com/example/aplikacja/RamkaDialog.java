...
public class RamkaDialog extends AppCompatDialogFragment {
    private EditText level;
    private RamkaDialogListener listener;
    ...
    public interface RamkaDialogListener {

        void ramka(String border);
    }
}